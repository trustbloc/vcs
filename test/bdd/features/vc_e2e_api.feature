...
Feature: Using VC REST API
  ...
  Scenario Outline: Store, retrieve, verify credential and presentation using different kind of profiles
    ...
    Examples:
      ...
      | myprofile_ud_unireg_ed25519_pv       | university_degree.json       |                                                                  |                                                                                          | ProofValue      |       {"driverURL":"http://uni-registrar-web:9080/1.0/register?driver-did-method-rest"}                                                                       | did:trustbloc   |   Ed25519Signature2018  |  Ed25519  |
      ...
      | myprofile_prc_unireg_ed25519         | permanent_resident_card.json |                                                                  |                                                                                          | JWS             |          {"driverURL":"http://uni-registrar-web:9080/1.0/register?driver-did-method-rest"}                                                                    | did:trustbloc   |   Ed25519Signature2018  |  Ed25519  |
