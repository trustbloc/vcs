...
Feature: Using VC REST API
  ...
  Scenario Outline: Store, retrieve, verify credential and presentation using different kind of profiles
    ...
    Examples:
      ...
      | myprofile_ud_ed25519    | university_degree.json       |                                                                  |                                                                                          | JWS             |                                                                                                                                                               | did:trustbloc   |   JsonWebSignature2020  |  Ed25519  |
      | myprofile_ud_p256_jws   | university_degree.json       |                                                                  |                                                                                          | JWS             |                                                                                                                                                               | did:trustbloc   |   JsonWebSignature2020  |  P256     |
      | myprofile_ud_p256_pv    | university_degree.json       |                                                                  |                                                                                          | ProofValue      |                                                                                                                                                               | did:trustbloc   |   JsonWebSignature2020  |  P256     |
      | myprofile_prc_ed25519   | permanent_resident_card.json |                                                                  |                                                                                          | JWS             |                                                                                                                                                               | did:trustbloc   |   JsonWebSignature2020  |  Ed25519  |
      | myprofile_prc_p256      | permanent_resident_card.json |                                                                  |                                                                                          | JWS             |                                                                                                                                                               | did:trustbloc   |   JsonWebSignature2020  |  P256     |
