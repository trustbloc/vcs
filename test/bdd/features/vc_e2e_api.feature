...
Feature: Using VC REST API
  ...
  Scenario Outline: Store, retrieve, verify credential and presentation using different kind of profiles
    ...
    Examples:
      ...
      | myprofile_ud_unireg_ed25519_pv       | university_degree.json       |                                                                  |                                                                                          | ProofValue      |       {"driverURL":"http://uni-registrar-web:9080/1.0/register?driver-did-method-rest"}                                                                       | did:trustbloc   |   JsonWebSignature2020  |  Ed25519  |
      | myprofile_ud_unireg_p256_jws         | university_degree.json       |                                                                  |                                                                                          | JWS             |       {"driverURL":"http://uni-registrar-web:9080/1.0/register?driver-did-method-rest"}                                                                       | did:trustbloc   |   JsonWebSignature2020  |  P256     |
      | myprofile_ud_local_ed25519_jws       | university_degree.json       |                                                                  |                                                                                          | JWS             |                                                                                                                                                               | did:trustbloc   |   JsonWebSignature2020  |  Ed25519  |
      | myprofile_ud_local_p256_pv           | university_degree.json       |                                                                  |                                                                                          | ProofValue      |                                                                                                                                                               | did:trustbloc   |   JsonWebSignature2020  |  P256     |
      | myprofile_prc_unireg_ed25519         | permanent_resident_card.json |                                                                  |                                                                                          | JWS             |          {"driverURL":"http://uni-registrar-web:9080/1.0/register?driver-did-method-rest"}                                                                    | did:trustbloc   |   JsonWebSignature2020  |  Ed25519  |
      | myprofile_prc_unireg_p256            | permanent_resident_card.json |                                                                  |                                                                                          | JWS             |          {"driverURL":"http://uni-registrar-web:9080/1.0/register?driver-did-method-rest"}                                                                    | did:trustbloc   |   JsonWebSignature2020  |  P256     |
      | myprofilewithdidv1                   | university_degree.json       |                                                                  |                                                                                          | JWS             |       {"driverURL":"http://uni-registrar-web:9080/1.0/register?driver-universalregistrar/driver-did-v1","options": {"ledger": "test", "keytype": "ed25519"}}  | did:v1:test:nym |   Ed25519Signature2018  |  Ed25519  |
      ...
      | myprofilewithdidsov                  | university_degree.json       |                                                                  |                                                                                          | JWS             |       {"driverURL":"https://uniregistrar.io/1.0/register?driver-universalregistrar/driver-did-sov","options": {"network":"danube"}}                           | did:sov:danube  |   Ed25519Signature2018  |  Ed25519  |
