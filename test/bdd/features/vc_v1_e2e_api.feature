...
Feature: Using VC REST API
  ...
  Scenario Outline: Store, retrieve, verify credential and presentation using different kind of profiles
    ...
    Examples:
      ...
      | i_myprofile_ud_es256_jwt    | v_myprofile_jwt | test_org     | university_degree.json          | jwt_vc_json-ld   | JWS             |
      | i_myprofile_ud_es384_jwt    | v_myprofile_jwt | test_org     | university_degree.json          | jwt_vc_json-ld   | JWS             |
      | i_myprofile_ud_es256k_jwt   | v_myprofile_jwt | test_org     | university_degree.json          | jwt_vc_json-ld   | JWS             |
      | i_myprofile_ud_es256_sdjwt  | v_myprofile_jwt | test_org     | university_degree.json          | jwt_vc_json-ld   | JWS             |
      | i_myprofile_ud_es384_sdjwt  | v_myprofile_jwt | test_org     | university_degree.json          | jwt_vc_json-ld   | JWS             |
      | i_myprofile_ud_es256k_sdjwt | v_myprofile_jwt | test_org     | university_degree.json          | jwt_vc_json-ld   | JWS             |
