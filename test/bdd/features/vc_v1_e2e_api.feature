...
Feature: Using VC REST API
  ...
  Scenario Outline: Store, retrieve, verify credential and presentation using different kind of profiles
    ...
    Examples:
      ...
      | i_myprofile_cp_p384         | i_myprofile_cp_p256         | v_myprofile_ldp | test_org     | crude_product.json              | ldp_vc         | JWS             |
      | i_myprofile_cp_p256         | i_myprofile_cmtr_p384       | v_myprofile_ldp | test_org     | crude_product.json              | ldp_vc         | JWS             |
      | i_myprofile_cmtr_p384       | i_myprofile_cmtr_p256       | v_myprofile_ldp | test_org     | certified_mill_test_report.json | ldp_vc         | JWS             |
      | i_myprofile_cmtr_p256       | i_myprofile_ud_es256_jwt    | v_myprofile_ldp | test_org     | certified_mill_test_report.json | ldp_vc         | JWS             |
      | i_myprofile_ud_es256_jwt    | i_myprofile_ud_es384_jwt    | v_myprofile_jwt | test_org     | university_degree.json          | jwt_vc_json-ld | JWS             |
      | i_myprofile_ud_es384_jwt    | i_myprofile_ud_es256k_jwt   | v_myprofile_jwt | test_org     | university_degree.json          | jwt_vc_json-ld | JWS             |
      | i_myprofile_ud_es256k_jwt   | i_myprofile_ud_es256_sdjwt  | v_myprofile_jwt | test_org     | university_degree.json          | jwt_vc_json-ld | JWS             |
      | i_myprofile_ud_es256_sdjwt  | i_myprofile_ud_es384_sdjwt  | v_myprofile_jwt | test_org     | university_degree.json          | jwt_vc_json-ld | JWS             |
      | i_myprofile_ud_es384_sdjwt  | i_myprofile_ud_es256k_sdjwt | v_myprofile_jwt | test_org     | university_degree.json          | jwt_vc_json-ld | JWS             |
      | i_myprofile_ud_es256k_sdjwt | i_myprofile_ud_P256k1       | v_myprofile_jwt | test_org     | university_degree.json          | jwt_vc_json-ld | JWS             |
