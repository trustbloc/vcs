...
type InitiateOIDC4CIResponse struct {
	...
	// Pre-authorized flow. Generated OTP pin for issuance. Issuer is responsible to deliver that pin to the final client (email,sms,etc).
	OtpPin *string `json:"otp_pin,omitempty"`
