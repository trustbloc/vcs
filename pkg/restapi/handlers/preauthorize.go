...
//go:generate mockgen -package handlers_test -destination preauthorize_mocks_test.go github.com/ory/fosite AccessResponder
//go:generate mockgen -package handlers_test -destination preauthorize_handler_mocks_test.go github.com/ory/fosite/handler/oauth2 CoreStorage,AccessTokenStrategy,RefreshTokenStrategy
