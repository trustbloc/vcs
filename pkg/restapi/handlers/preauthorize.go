...
//go:generate mockgen -package handlers_test -destination preauthorize_mocks_handler_test.go github.com/ory/fosite/handler/oauth2 CoreStorage,AccessTokenStrategy,RefreshTokenStrategy
