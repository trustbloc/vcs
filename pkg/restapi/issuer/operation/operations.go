...
func (o *Operation) getVaultIDFromVaultLocationURL(vaultLocationURL string) string {
	vaultLocationURLSplitUp := strings.Split(vaultLocationURL, "/")
	vaultID := vaultLocationURLSplitUp[len(vaultLocationURLSplitUp)-1]
...
func (o *Operation) createIssuerProfileVault(profileName string) (string, error) {
	...
	edvVaultID := o.getVaultIDFromVaultLocationURL(vaultLocationURL)
