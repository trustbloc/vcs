...
func (o *CommonDID) createDIDUniRegistrar(keyType, signatureType, purpose string,
	...
	opts = append(opts,
		uniregistrar.WithPublicKey(&didmethodoperation.PublicKey{
			ID: recoveryKey, Type: didclient.JWSVerificationKey2020, KeyType: didclient.Ed25519KeyType,
			Value:    base64.StdEncoding.EncodeToString(recoveryPubKey),
			Encoding: didclient.PublicKeyEncodingJwk, Recovery: true}),
		uniregistrar.WithPublicKey(&didmethodoperation.PublicKey{
			ID: updateKey, Type: didclient.JWSVerificationKey2020, KeyType: didclient.Ed25519KeyType,
...
func (o *CommonDID) createDID(keyType, signatureType string) (string, string, error) {
	...
	opts = append(opts,
		didclient.WithPublicKey(&didclient.PublicKey{ID: recoveryKey, KeyType: didclient.Ed25519KeyType,
			Type: didclient.JWSVerificationKey2020, Value: recoveryPubKey,
			Encoding: didclient.PublicKeyEncodingJwk, Recovery: true}),
		didclient.WithPublicKey(&didclient.PublicKey{ID: updateKey, KeyType: didclient.Ed25519KeyType,
