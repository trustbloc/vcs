...
func (mr *MockawsClientMockRecorder) ScheduleKeyDeletion(ctx, params interface{}, optFns ...interface{}) *awsClientScheduleKeyDeletionCall {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, params}, optFns...)
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ScheduleKeyDeletion", reflect.TypeOf((*MockawsClient)(nil).ScheduleKeyDeletion), varargs...)
	return &awsClientScheduleKeyDeletionCall{Call: call}
}

// awsClientScheduleKeyDeletionCall wrap *gomock.Call
type awsClientScheduleKeyDeletionCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *awsClientScheduleKeyDeletionCall) Return(arg0 *kms.ScheduleKeyDeletionOutput, arg1 error) *awsClientScheduleKeyDeletionCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *awsClientScheduleKeyDeletionCall) Do(f func(context.Context, *kms.ScheduleKeyDeletionInput, ...func(*kms.Options)) (*kms.ScheduleKeyDeletionOutput, error)) *awsClientScheduleKeyDeletionCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *awsClientScheduleKeyDeletionCall) DoAndReturn(f func(context.Context, *kms.ScheduleKeyDeletionInput, ...func(*kms.Options)) (*kms.ScheduleKeyDeletionOutput, error)) *awsClientScheduleKeyDeletionCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
